  ...
  <div id="main-content" className="bg-white border">
        ...
        <div className="card" style={{width: "100%",display:"flex",alignItems:"center"}}>
            ...
            <div className="card-body">
                <h3 class="card-title text-uppercase" style={{fontSize:"45px",fontWeight:"600"}}>{user.displayName}</h3>
                <p class="">Email: {user.email}</p>
            </div>
            
            <div class="card-body">
                <Link  to="/profiles/myprofile/updateprofile">
                    <div style={{color:"blue",fontWeight:"400",cursor:"pointer"}}><i class="ri-edit-line"></i><u>edit profile</u></div>
                </Link >
            </div>
        </div>
